...
public class StartViewCard extends View {
    ...
    public StartViewCard(GWENT game, Faction faction, CommanderInformation commander) {
        super(game);
        ...
        changeCommander.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                game.changeScreen(new StartViewCommander(game, faction));
            }
        ...
        deckUpdater();
        cardScroll = new ScrollPane(card, scrollPane);
        ...
        deckScroll = new ScrollPane(deck, scrollPane);
